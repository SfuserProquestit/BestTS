...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Testing service cloud</description>
    ...
    <workspaceMappings>
        ...
        <mapping>
            <fieldName>SVMXC__Renewed_From__c</fieldName>
            <tab>SVMXC__Service_Contract__c</tab>
        </mapping>
        <mapping>
            <tab>SVMXC__Service_Group_Members__c</tab>
        ...
        <mapping>
            <fieldName>SVMXC__Company__c</fieldName>
            <tab>SVMXC__Service_Order__c</tab>
        </mapping>
        <mapping>
            <fieldName>SVMXC__Service_Contract__c</fieldName>
            <tab>standard-Case</tab>
        </mapping>
        <mapping>
            <tab>standard-OtherUserProfile</tab>
